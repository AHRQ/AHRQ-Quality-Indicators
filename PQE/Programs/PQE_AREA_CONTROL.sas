 ...
 * The software also requires the following files:
   ...
   2. PQE_Dx_Macros_v2025.SAS Standard processes used by the other SAS programs.
                              The user does not need to open.
                            
   3. 2000-2024_Population_Files_v2025.txt  Population file with counts by area, age, and sex.
                                            Required for area rate calculation. Available as a 
                                            separate download from the AHRQ website.

   4. PQE_AREA_Sigvar_Array_v2025.SAS  File with noise and signal variance estimates 
                                       and reference rates for smoothing by age and sex.

   5. PQE_AREA_Sigvar_Array_SES_v2025.SAS  File with noise and signal variance estimates 
                                           and reference rates for smoothing by age, sex and
                                           socioeconomic status (SES).

   6. PQE_AREA_OE_Array_v2025.SAS  Array for observed/expected (OE) ratio adjustment from 
                                   reference population based on risk adjustment models. 
                                   The software provides two options to use OE ratio adjustment.

   7. PQE_AREA_OE_Array_SES_v2025.SAS  Array for OE ratio adjustment from reference population 
 ...
 * See the AHRQ_PQE_SAS_v2025_ICD10_Release_Notes.txt file for version change details.
...
%LET SUFX =  v2025;                             *<===USER may modify;
 ...
 * ---------------------------------------------------------------- ;
%LET POPYEAR = 2024;                            *<===USER may modify;

 * ---------------------------------------------------------------- ;
 * --- SET LOCATION OF POPULATION FILE                          --- ;
 * ---------------------------------------------------------------- ;
filename POPFILE  "&PATHNAME.\ParmFiles\2000-2024_Population_Files_v2025.txt";  *<===USER may modify; 
...
%include MacLib(PQE_Dx_Macros_v2025.SAS);

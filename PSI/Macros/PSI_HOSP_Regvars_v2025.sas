...
%let ageonly_ = Age_LT30 Age_30_34 Age_35_39 Age_40_44 Age_45_49 Age_50_54 Age_55_59 Age_60_64 Age_65_69 Age_70_74
                Age_75_79 Age_80_84 Age_85_89 Age_90Plus Age_85Plus;
...
%let agesx_ = Age_LT30_MALE Age_30_34_MALE Age_35_39_MALE Age_40_44_MALE Age_45_49_MALE Age_50_54_MALE Age_55_59_MALE Age_60_64_MALE Age_70_74_MALE
              Age_75_79_MALE Age_80_84_MALE Age_85_89_MALE Age_90Plus_MALE Age_85Plus_MALE;
...
/*-- Create the comorbidity count variables for PSI --*/
%macro docomorb;
   comorb_NonWt  =sum(%do i = 1 %to %eval(&cnum.-1); %scan(&comorb_.,&i.), %end;  %scan(&comorb_.,&cnum.));
%mend docomorb;
%docomorb;
if 1 < comorb_NonWt <= 4 then PS03_NonWt_1              =1; else PS03_NonWt_1              =0;
if     comorb_NonWt >= 5 then PS03_NonWt_2              =1; else PS03_NonWt_2              =0;
if 3 < comorb_NonWt <= 6 then PS04_DVT_PE_NonWt_1       =1; else PS04_DVT_PE_NonWt_1       =0;
if     comorb_NonWt >= 7 then PS04_DVT_PE_NonWt_2       =1; else PS04_DVT_PE_NonWt_2       =0;
...
if 2 < comorb_NonWt <= 5 then PS04_PNEUMONIA_NonWt_1    =1; else PS04_PNEUMONIA_NonWt_1    =0;
if     comorb_NonWt >= 6 then PS04_PNEUMONIA_NonWt_2    =1; else PS04_PNEUMONIA_NonWt_2    =0;
if 2 < comorb_NonWt <= 5 then PS04_SEPSIS_NonWt_1       =1; else PS04_SEPSIS_NonWt_1       =0;
if     comorb_NonWt >= 6 then PS04_SEPSIS_NonWt_2       =1; else PS04_SEPSIS_NonWt_2       =0;
...
if 1 < comorb_NonWt <= 2 then PS06_NonWt_1              =1; else PS06_NonWt_1              =0;
if     comorb_NonWt >= 3 then PS06_NonWt_2              =1; else PS06_NonWt_2              =0;
if 0 < comorb_NonWt <= 2 then PS07_NonWt_1              =1; else PS07_NonWt_1              =0;
if     comorb_NonWt >= 3 then PS07_NonWt_2              =1; else PS07_NonWt_2              =0;
if 3 < comorb_NonWt <= 5 then PS08_NonWt_1              =1; else PS08_NonWt_1              =0;
if     comorb_NonWt >= 6 then PS08_NonWt_2              =1; else PS08_NonWt_2              =0;
...
if 3 < comorb_NonWt <= 5 then PS11_NonWt_1              =1; else PS11_NonWt_1              =0;
if     comorb_NonWt >= 6 then PS11_NonWt_2              =1; else PS11_NonWt_2              =0;
...
if 1 < comorb_NonWt <= 4 then PS15_NonWt_1              =1; else PS15_NonWt_1              =0;
if     comorb_NonWt >= 5 then PS15_NonWt_2              =1; else PS15_NonWt_2              =0;
 
/*stratification interactions selected */
PS14s_Age_50_54  = PS14s*Age_50_54  ;
...
PS14s_CMR_DEPRESS  = PS14s*CMR_DEPRESS  ;
PS14s_CMR_DIAB_CX  = PS14s*CMR_DIAB_CX  ;
...
PS14s_CMR_THYROID_HYPO  = PS14s*CMR_THYROID_HYPO  ;

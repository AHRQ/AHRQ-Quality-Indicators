...
if 3 < comorb_NonWt <= 4 then PS02_NonWt_1              =1; else PS02_NonWt_1              =0;
if     comorb_NonWt >= 5 then PS02_NonWt_2              =1; else PS02_NonWt_2              =0;
if 2 < comorb_NonWt <= 4 then PS03_NonWt_1              =1; else PS03_NonWt_1              =0;
...
if 1 < comorb_NonWt <= 4 then PS14_NONOPEN_NonWt_1      =1; else PS14_NONOPEN_NonWt_1      =0;
if     comorb_NonWt >= 5 then PS14_NONOPEN_NonWt_2      =1; else PS14_NONOPEN_NonWt_2      =0;
if 1 < comorb_NonWt <= 3 then PS14_OPEN_NonWt_1         =1; else PS14_OPEN_NonWt_1         =0;
if     comorb_NonWt >= 4 then PS14_OPEN_NonWt_2         =1; else PS14_OPEN_NonWt_2         =0;

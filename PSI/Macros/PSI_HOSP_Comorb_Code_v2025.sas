...
/*                                                                */
/* Program:     PSI_HOSP_Comorb_Code_v2025.sas                    */
/*                                                                */
...
/*   SET CMR VERSION                         */
/*********************************************/ 
%LET CMR_VERSION = "2025.1" ;               *<=== DO NOT MODIFY;
      ...
      IF DX(I) NE " " THEN DO;
         ...
         IF (EXEMPTPOA(I) = 1)  or (EXEMPTPOA(I) = 0 AND DXPOA(I) IN ("Y","W")) THEN DO;
            ...
            IF DXVALUE = "LIVER_MLD_NEURO" THEN DO;
               ...
               CMR_NEURO_OTH = 1;
            END;
            IF DXVALUE = "NEURO_OTH_SEIZ"    THEN CMR_NEURO_OTH     = 1;
            IF DXVALUE = "NEURO_OTH_SEIZ"    THEN CMR_NEURO_SEIZ    = 1;
         END;

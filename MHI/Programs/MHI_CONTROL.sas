...
*  VERSION: SAS Beta version of Maternal Health Indicators v2025
 ...
 * The software also requires the following files (all included except discharges):
  ...
  2. MHI_Dx_Pr_Macros_v2025.sas  Standard processes used by the other SAS programs.
...
*   See the AHRQ_MHI_SAS_v2025_ICD10_Release_Notes.txt file for version change details.
 ...
 * ------------------------------------------------------------------ ;
 * --- SELECT THE POPULATION DATA FOR MHI SOFTWARE                --- ;
 * --- 1 = UNLINKED INPATIENT DATA                                --- ;
 * --- 2 = LINKED INPATIENT DATA                                  --- ;
 * --- 3 = LINKED INPATIENT AND ED VISITS                         --- ;
 * ------------------------------------------------------------------ ;
%LET REF_POP = 1;                                 *<===USER may modify;
 ...
 * ------------------------------------------------------------------ ;
%LET OUTFILE_MEAS = MHMSR_&SUFX._&ref_pop.;       *<===USER may modify;
 ...
 * ------------------------------------------------------------------ ;
%LET DELFILE  = MHI_DELETED_&SUFX._&ref_pop.;     *<===USER may modify;
 ...
 * ------------------------------------------------------------------ ;
%LET  OUTFILE_AREAOBS  = MHAO_&SUFX._&ref_pop.;   *<===USER may modify;
 ...
 * --- OF THE FILE.                                               --- ;
 * ------------------------------------------------------------------ ;
filename MHTXTAOB "&PATHNAME.\SASData\MHAO_&SUFX._&ref_pop..TXT";    *<===USER may modify;
...
%include MacLib(MHI_Dx_Pr_Macros_v2025.sas);
